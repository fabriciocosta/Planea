...
var ToolsController = {
  ...
  doCommand : function(cmd) {
    switch (cmd) {
      case "cmd_options":
      {
        window.openDialog("chrome://planea/content/options.xul", "options", "centerscreen,modal");
        break;
      }
    }
  }
...
var HelpController = {
  ...
  doCommand : function(cmd) {
    switch (cmd) {
      case "cmd_about":
      {
        window.openDialog("chrome://planea/content/about.xul", "about", "centerscreen,modal");
        break;
      }
    }
  }
